...
static syscall_t table[330] = {
    ...
    {35, "nanosleep", 2, NUM, CONST_STRUCT_TIMESPEC_P, \
    ...
    {45, "recvfrom", 6, NUM, NUM, VOID_P, NUM, NUM, \
    ...
    {78, "getdents", 3, NUM, UNSIGNED, STRUCT_LINUX_DIRENT_P, \
        UNSIGNED, 0, 0, 0},
    ...
    {96, "gettimeofday", 2, NUM, STRUCT_TIMEVAL_P, \
    ...
    {101, "ptrace", 4, NUM, ENUM_____REQUEST, NUM, \
        VOID_P, VOID_P, 0, 0},
    ...
    {126, "capset", 2, NUM, CAP_USER_HEADER_T, \
    ...
    {131, "sigaltstack", 2, NUM, CONST_STACK_T_P, \
        STACK_T_P, 0, 0, 0, 0},
    ...
    {142, "sched_setparam", 2, NUM, NUM, \
        CONST_STRUCT_SCHED_PARAM_P, 0, 0, 0, 0},
    {143, "sched_getparam", 2, NUM, NUM, \
        STRUCT_SCHED_PARAM_P, 0, 0, 0, 0},
    {144, "sched_setscheduler", 3, NUM, NUM, \
        NUM, CONST_STRUCT_SCHED_PARAM_P, 0, 0, 0},
